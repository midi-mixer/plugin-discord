...
var rpcord_1 = require("rpcord");
require("midi-mixer-plugin");
var api_1 = require("./api");
var midiMixerRpc = null;
var api = null;
var cleanUpConnections = function () {
    if (midiMixerRpc) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                midiMixerRpc = new rpcord_1.RPClient(midiMixerClientId);
                return [4 /*yield*/, midiMixerRpc.connect()];
            case 1:
                _a.sent();
                return [4 /*yield*/, midiMixerRpc.setActivity(new rpcord_1.Presence()
...
var connect = function () { return __awaiter(void 0, void 0, void 0, function () {
    var settings, clientId, clientSecret, presence, showPresence, clientIdValid, clientSecretValid, scopes, rpc;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                /**
            ...
            case 1:
                ...
                rpc = new rpcord_1.RPClient(clientId, {
                    secret: clientSecret,
                    scopes: scopes,
                });
                api = new api_1.DiscordApi(rpc);
                return [2 /*return*/];
        }
    });
}); };
